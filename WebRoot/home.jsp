...
<body>
    <div id="header">
        <a href ="${pageContext.request.contextPath}/home.jsp"><h1>诚安汽车租赁</h1></a>
        <div class="header_a">
            <ul class="ul1">
                <li><a href="#" class="a1" onclick="datadel()">车辆信息</a></li>
                ...
                <c:choose>
                	<c:when test="${not empty sessionScope.user }" >
                		...
                		<li>
                		<span class="lr_b">尊敬的&nbsp;
                		<span style="font-size:16px;">${sessionScope.user.username },</span>
                		&nbsp;您好！</span>
                		<a style="color :#fff;text-decoration:none;" href="${pageContext.request.contextPath }/user/login.jsp">重新登录</a>
                		</li>
